...
#Creating a vector only for mean and std cointaining columns 
means_stds  <- grepl("mean|std",colnames)
#Selecting only the mean and std cointaining columns
